...
// Create a theme based on mode (light or dark)
  ...
  return createTheme({
    palette: {
      ...
      background: {
        ...
        contrast: mode === 'dark' ? '#2d2d2d' : '#f0f0f0',
      },
      text: {
      ...
      MuiButton: {
        styleOverrides: {
          root: {
            ...
            padding: '10px 24px',
            boxShadow: mode === 'dark' 
              ? '0px 3px 5px -1px rgba(0,0,0,0.3),0px 6px 10px 0px rgba(0,0,0,0.2)'
              : '0px 3px 5px -1px rgba(0,0,0,0.08),0px 6px 10px 0px rgba(0,0,0,0.05)',
            '&:hover': {
              transform: 'translateY(-2px)',
              boxShadow: mode === 'dark'
                ? '0px 6px 10px -1px rgba(0,0,0,0.3),0px 8px 12px 0px rgba(0,0,0,0.22)'
                : '0px 6px 10px -1px rgba(0,0,0,0.12),0px 8px 12px 0px rgba(0,0,0,0.08)',
      ...
      MuiCard: {
        styleOverrides: {
          root: {
            borderRadius: 12,
            boxShadow: mode === 'dark'
              ? '0px 6px 16px -8px rgba(0,0,0,0.5), 0px 9px 28px 0px rgba(0,0,0,0.3)'
              : '0px 6px 16px -8px rgba(0,0,0,0.08), 0px 9px 28px 0px rgba(0,0,0,0.05)',
            transition: 'transform 0.3s ease, box-shadow 0.3s ease',
            '&:hover': {
              transform: 'translateY(-4px)',
              boxShadow: mode === 'dark'
                ? '0px 12px 24px -10px rgba(0,0,0,0.5), 0px 18px 40px 0px rgba(0,0,0,0.32)'
                : '0px 12px 24px -10px rgba(0,0,0,0.12), 0px 18px 40px 0px rgba(0,0,0,0.08)',
            },
            ...(mode === 'dark' && {
